(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueViewports"] = factory();
	else
		root["VueViewports"] = factory();
})(this, function() {
...
var _vueThrottleEvent = __webpack_require__(11);

var _vueThrottleEvent2 = _interopRequireDefault(_vueThrottleEvent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var VueViewports = {
  install: function install(Vue) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { 0: 'sub-mobile', 320: 'mobile', 768: 'tablet', 1024: 'desktop', 1920: 'hd-desktop', 2560: 'qhd-desktop', 3840: 'uhd-desktop' };

    var updateEventName = 'VueViewports$updateCurrentViewport';
    Vue.prototype.$viewportsUpdateEventName = updateEventName;

    VueViewports._updateCurrentViewport.call(undefined, Vue, options);

    _vueThrottleEvent2.default._throttle('resize', updateEventName, window);

    window.addEventListener(updateEventName, VueViewports._updateCurrentViewport.bind(undefined, Vue, options));
  },
  _updateCurrentViewport: function _updateCurrentViewport(Vue, options) {
    Vue.prototype.$currentViewport = VueViewports._getCurrentViewport(options);
  },
  _getCurrentViewport: function _getCurrentViewport(options) {
    var arrayOptions = VueViewports._sortOptions(options);

    var windowWidth = window.innerWidth;

    var compatibleValue = arrayOptions.reverse().find(function (value) {
  ...
  _sortOptions: function _sortOptions(options) {
    return Object.keys(options).map(Number).sort(function (a, b) {
      return a - b;
    });
  }
};

exports.default = VueViewports;
